...
def index(request):
    ...
    # Possession Status Section Dynamic Data
ready_count = Project.objects.filter(construction_status="Ready To Move", active=True).count()
under_count = Project.objects.filter(construction_status="Under Construction", active=True).count()
launch_count = Project.objects.filter(construction_status="New Launch", active=True).count()

ready_img = Project.objects.filter(construction_status="Ready To Move", active=True).first()
under_img = Project.objects.filter(construction_status="Under Construction", active=True).first()
launch_img = Project.objects.filter(construction_status="New Launch", active=True).first()
